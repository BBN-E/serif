...
#ifndef AR_LEFT_CLITIC_FT_H
#define AR_LEFT_CLITIC_FT_H
...
class ArabicLeftCliticFT : public P1RelationFeatureType {
public:
	ArabicLeftCliticFT() : P1RelationFeatureType(Symbol(L"left-clitic")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if (ArabicWordConstants::isPrefixClitic(head1)) {
			has_clitic = true;
			clitic = head1;
		}
		// check previous word
		else {
			const SynNode *term = o->getMention1()->getNode()->getHeadPreterm()->getHead();
