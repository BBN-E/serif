...
#ifndef AR_LEFT_HEAD_WORD_FT_H
#define AR_LEFT_HEAD_WORD_FT_H
...
class ArabicLeftHeadWordFT : public P1RelationFeatureType {
public:
	ArabicLeftHeadWordFT() : P1RelationFeatureType(Symbol(L"left-head-word")) {}
								...
								DTFeature **resultArray) const
	{
		...
		*/
		...
		if(RelationUtilities::get()->distIsLessThanCutoff(o->getMention1(), o->getMention2())){
			...
			resultArray[1] = _new DTQuadgramFeature(this, state.getTag(), s1, s2, head1);
			return 2;
		}
		else{
			wchar_t buffer[300];
