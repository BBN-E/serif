...
#ifndef PL_TYPE_PARENT_WORD_HW_FT_H
#define PL_TYPE_PARENT_WORD_HW_FT_H
...
class PLTypeParentWordHWFT : public DTCorefFeatureType {
public:
	PLTypeParentWordHWFT() : DTCorefFeatureType(Symbol(L"type-parent-word-hw")) {}
