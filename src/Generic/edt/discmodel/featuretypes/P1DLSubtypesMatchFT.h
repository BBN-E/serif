...
#ifndef P1DL_SUBTYPESMATCH_FT_H
#define P1DL_SUBTYPESMATCH_FT_H
...
class P1DLSubtypesMatchFT : public DTCorefFeatureType {
public:
	P1DLSubtypesMatchFT() : DTCorefFeatureType(Symbol(L"p1dl-subtypesmatch")) {}
