...
#ifndef HW_MATCH_AND_MOD_NAME_MATCH_FT_H
#define HW_MATCH_AND_MOD_NAME_MATCH_FT_H
...
class HWMatchAndModNameMatchFT : public DTCorefFeatureType {
public:
	HWMatchAndModNameMatchFT() : DTCorefFeatureType(Symbol(L"hw-match-and-mod-name-match")) {}
