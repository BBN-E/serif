...
#ifndef ENTNUMERIC_AND_NOTMENTNUMERIC_FT_H
#define ENTNUMERIC_AND_NOTMENTNUMERIC_FT_H
...
class EntNumericAndNotMentNumericFT : public DTCorefFeatureType {
public:
	EntNumericAndNotMentNumericFT() : DTCorefFeatureType(Symbol(L"ent-numeric-and-not-ment-numeric")) {}
