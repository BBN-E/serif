...
#ifndef POSTMODANDHWMATCH_FT_H
#define POSTMODANDHWMATCH_FT_H
 ...
 */
class PostmodHWMatchFT : public DTCorefFeatureType {
public:
	PostmodHWMatchFT() : DTCorefFeatureType(Symbol(L"postmod-hw-match")) {}
								...
								DTFeature **resultArray) const
	{
		...
		notInHWMap = o->getPostmodMentionMapper();
