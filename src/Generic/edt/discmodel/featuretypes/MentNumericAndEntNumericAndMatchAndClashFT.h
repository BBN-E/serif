...
#ifndef MENTNUMERIC_AND_ENTNUMERIC_ANDMATCH_ANDCLASH_FT_H
#define MENTNUMERIC_AND_ENTNUMERIC_ANDMATCH_ANDCLASH_FT_H
...
class MentNumericAndEntNumericAndMatchAndClashFT : public DTCorefFeatureType {
public:
	MentNumericAndEntNumericAndMatchAndClashFT() : DTCorefFeatureType(Symbol(L"ment-numeric-and-ent-numeric-and-match-and-clash")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(!has_numeric_clash)
			return 0;
		bool has_numeric_match = DescLinkFeatureFunctions::hasNumericMatch( o->getMention(),
			o->getEntity(), o->getEntitySet());


		if(ment_has_numeric && ent_has_numeric && has_numeric_clash && has_numeric_match ){
