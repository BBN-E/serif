...
#ifndef FULLMENTMENT_EDITDISTANCE3_FT_H
#define FULLMENTMENT_EDITDISTANCE3_FT_H
...
class FullMentMentEditDistance3FT : public DTCorefFeatureType {
public:
	FullMentMentEditDistance3FT() : DTCorefFeatureType(Symbol(L"full-ment-ment-edit-dist3")) {
	}
	...
	int fullEditDistance() const {
		static const int cost_del = 1;
		static const int cost_ins = 2;
