...
#ifndef HWNODE_MATCH_AND_NUMERIC_MATCH_FT_H
#define HWNODE_MATCH_AND_NUMERIC_MATCH_FT_H
...
class HWNodeMatchAndNumericMatchFT : public DTCorefFeatureType {
public:
	HWNodeMatchAndNumericMatchFT() : DTCorefFeatureType(Symbol(L"hw-node-match-and-numeric-match")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(val && ment_has_numeric && ent_has_numeric && has_numeric_match ){
