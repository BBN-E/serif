...
#ifndef MENTMENT_EDITDISTANCE_FT_H
#define MENTMENT_EDITDISTANCE_FT_H
...
class MentMentEditDistanceFT : public DTCorefFeatureType {
public:
	MentMentEditDistanceFT() : DTCorefFeatureType(Symbol(L"ment-ment-edit-dist")) {}
