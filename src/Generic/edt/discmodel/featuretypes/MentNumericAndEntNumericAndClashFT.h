...
#ifndef MENTNUMERIC_AND_ENTNUMERIC_ANDCLASH_FT_H
#define MENTNUMERIC_AND_ENTNUMERIC_ANDCLASH_FT_H
...
class MentNumericAndEntNumericAndClashFT : public DTCorefFeatureType {
public:
	MentNumericAndEntNumericAndClashFT() : DTCorefFeatureType(Symbol(L"ment-numeric-and-ent-numeric-and-clash")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(ment_has_numeric && ent_has_numeric && has_numeric_clash  ){
