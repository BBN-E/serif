...
#ifndef FULLMENTMENT_EDITDISTANCE_FT_H
#define FULLMENTMENT_EDITDISTANCE_FT_H
...
class FullMentMentEditDistanceFT : public DTCorefFeatureType {
public:
	FullMentMentEditDistanceFT() : DTCorefFeatureType(Symbol(L"full-ment-ment-edit-dist")) {
	}
