...
#ifndef HW_MATCH_AND_NUMERIC_CLASH_FT_H
#define HW_MATCH_AND_NUMERIC_CLASH_FT_H
...
class HWMatchAndNumericClashFT : public DTCorefFeatureType {
public:
	HWMatchAndNumericClashFT() : DTCorefFeatureType(Symbol(L"hw-match-and-numeric-clash")) {}
