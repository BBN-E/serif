...
#ifndef HW_MATCH_AND_NUMERIC_MATCH_FT_H
#define HW_MATCH_AND_NUMERIC_MATCH_FT_H
...
class HWMatchAndNumericMatchFT : public DTCorefFeatureType {
public:
	HWMatchAndNumericMatchFT() : DTCorefFeatureType(Symbol(L"hw-match-and-numeric-match")) {}
