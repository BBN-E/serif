...
#ifndef HWNODE_MATCH_AND_MOD_NAME_CLASH_FT_H
#define HWNODE_MATCH_AND_MOD_NAME_CLASH_FT_H
...
class HWNodeMatchAndModNameClashFT : public DTCorefFeatureType {
public:
	HWNodeMatchAndModNameClashFT() : DTCorefFeatureType(Symbol(L"hw-node-match-and-mod-name-clash")) {}
