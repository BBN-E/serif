...
#ifndef PL_TYPE_PARENT_WORD_WC_FT_H
#define PL_TYPE_PARENT_WORD_WC_FT_H
...
class PLTypeParentWordWCFT : public DTCorefFeatureType {
public:
	PLTypeParentWordWCFT() : DTCorefFeatureType(Symbol(L"type-parent-word-wc")) {}
