...
#ifndef MENTMENT_EDITDISTANCE3_FT_H
#define MENTMENT_EDITDISTANCE3_FT_H
...
class MentMentEditDistance3FT : public DTCorefFeatureType {
public:
	MentMentEditDistance3FT() : DTCorefFeatureType(Symbol(L"ment-ment-edit-dist3")) {}
