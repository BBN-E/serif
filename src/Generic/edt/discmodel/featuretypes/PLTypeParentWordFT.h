...
#ifndef PL_TYPE_PARENT_WORD_FT_H
#define PL_TYPE_PARENT_WORD_FT_H
...
class PLTypeParentWordFT : public DTCorefFeatureType {
public:
	PLTypeParentWordFT() : DTCorefFeatureType(Symbol(L"type-parent-word")) {}
