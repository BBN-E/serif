...
#ifndef ENT_ONLYNAMES_AND_MOD_NAME_CLASH_FT_H
#define ENT_ONLYNAMES_AND_MOD_NAME_CLASH_FT_H
...
class EntOnlyNamesAndModNameClashFT : public DTCorefFeatureType {
public:
	EntOnlyNamesAndModNameClashFT() : DTCorefFeatureType(Symbol(L"ent-only-names-and-mod-name-clash")) {}
