...
#ifndef HWNODE_MATCH_AND_MOD_NAME_MATCH_FT_H
#define HWNODE_MATCH_AND_MOD_NAME_MATCH_FT_H
...
class HWNodeMatchAndModNameMatchFT : public DTCorefFeatureType {
public:
	HWNodeMatchAndModNameMatchFT() : DTCorefFeatureType(Symbol(L"hw-node-match-and-mod-name-match")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(!val)
			return 0;
		bool val3 = DescLinkFeatureFunctions::hasModName(o->getMention());//, o->getEntitySet());
		if(!val3)
			return 0;
