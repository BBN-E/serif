...
#ifndef UT_FEATURE_ALIAS_OF
#define UT_FEATURE_ALIAS_OF
...
/* 
 *
 * ported from features.py:of_alias
 */
class UTFeatureAliasOf : public UTFeatureType {
public:

   UTFeatureAliasOf() : UTFeatureType(Symbol(L"UTFeatureAliasOf")) {
...
public:
  Symbol detect(const SynNode &leftNode,
     ...
     return alias->detect(leftNode, rightNode, lam, false, true /* ignore lower */, true /* of */, false);
  }
};
