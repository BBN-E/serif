...
#ifndef EM_NEXT_WORD_BIGRAM_FEATURE_TYPE_H
#define EM_NEXT_WORD_BIGRAM_FEATURE_TYPE_H
...
class EMNextWordBigramFeatureType : public EventModalityFeatureType {
public:
	EMNextWordBigramFeatureType() : EventModalityFeatureType(Symbol(L"next-word-bigram")) {}
