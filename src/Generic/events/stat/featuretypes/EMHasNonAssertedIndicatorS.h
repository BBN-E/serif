...
#ifndef EM_HAS_NONASSERTED_INDICATOR_S_H
#define EM_HAS_NONASSERTED_INDICATOR_S_H
...
class hasNonAssertedIndicatorS : public EventModalityFeatureType {

public:
	hasNonAssertedIndicatorS() : EventModalityFeatureType(Symbol(L"has-nonasserted-indicator-aboveS")) {}
