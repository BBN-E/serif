...
#ifndef ET_NEXT_WC12_FEATURE_TYPE_H
#define ET_NEXT_WC12_FEATURE_TYPE_H
...
class ETNextWC12FeatureType : public EventTriggerFeatureType {
public:
	ETNextWC12FeatureType() : EventTriggerFeatureType(Symbol(L"next-wc12")) {}
