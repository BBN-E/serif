...
#ifndef EM_LED_BY_MODAL_H
#define EM_LED_BY_MODAL_H
...
class isLedByModalWord : public EventModalityFeatureType {

public:
	isLedByModalWord() : EventModalityFeatureType(Symbol(L"is-led-by-modal-word")) {}
