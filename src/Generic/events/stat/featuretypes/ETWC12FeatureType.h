...
#ifndef ET_WC12_FEATURE_TYPE_H
#define ET_WC12_FEATURE_TYPE_H
...
class ETWC12FeatureType : public EventTriggerFeatureType {
public:
	ETWC12FeatureType() : EventTriggerFeatureType(Symbol(L"wc12")) {}
								...
								DTFeature **resultArray) const
	{
		...
		resultArray[0] = _new DTIntFeature(this, state.getTag(),  o->getWordClusterMC().c12());
		return 1;
	}
};
