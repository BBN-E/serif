...
#ifndef ET_NEXT_TRIGRAM_FEATURE_TYPE_H
#define ET_NEXT_TRIGRAM_FEATURE_TYPE_H
...
class ETNextTrigramFeatureType : public EventTriggerFeatureType {
public:
	ETNextTrigramFeatureType() : EventTriggerFeatureType(Symbol(L"next-trigram")) {}
								...
								DTFeature **resultArray) const
	{
		...
		resultArray[0] = _new DTQuadgramFeature(this, state.getTag(),
			o->getStemmedWord(), o->getNextWord(), o->getSecondNextWord());
		return 1;
	}
};
