...
#ifndef EM_ALLEGED_ADVERB_H
#define EM_ALLEGED_ADVERB_H
...
class isLedByAllegedAdverb : public EventModalityFeatureType {

public:
	isLedByAllegedAdverb() : EventModalityFeatureType(Symbol(L"is-led-by-alleged-adverb")) {
