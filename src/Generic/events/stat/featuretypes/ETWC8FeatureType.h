...
#ifndef ET_WC8_FEATURE_TYPE_H
#define ET_WC8_FEATURE_TYPE_H
...
class ETWC8FeatureType : public EventTriggerFeatureType {
public:
	ETWC8FeatureType() : EventTriggerFeatureType(Symbol(L"wc8")) {}
								...
								DTFeature **resultArray) const
	{
		...
		resultArray[0] = _new DTIntFeature(this, state.getTag(), o->getWordClusterMC().c8());
		return 1;
	}
};
