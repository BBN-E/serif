...
#ifndef ET_PREV_WC16_FEATURE_TYPE_H
#define ET_PREV_WC16_FEATURE_TYPE_H
...
class ETPrevWC16FeatureType : public EventTriggerFeatureType {
public:
	ETPrevWC16FeatureType() : EventTriggerFeatureType(Symbol(L"prev-wc16")) {}
