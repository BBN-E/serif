...
#ifndef EM_WORD_FEATURE_TYPE_H
#define EM_WORD_FEATURE_TYPE_H
...
class EMWordFeatureType : public EventModalityFeatureType {
public:
	EMWordFeatureType() : EventModalityFeatureType(Symbol(L"word")) {}
