...
#ifndef ET_STEMMED_WORD_FEATURE_TYPE_H
#define ET_STEMMED_WORD_FEATURE_TYPE_H
...
class ETStemmedWordFeatureType : public EventTriggerFeatureType {
public:
	ETStemmedWordFeatureType() : EventTriggerFeatureType(Symbol(L"stemmed-word")) {}
