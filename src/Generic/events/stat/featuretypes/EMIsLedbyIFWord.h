...
#ifndef EM_LED_BY_IF_H
#define EM_LED_BY_IF_H
...
class isLedByIFWord : public EventModalityFeatureType {

public:
	isLedByIFWord() : EventModalityFeatureType(Symbol(L"is-led-by-if-word")) {}
