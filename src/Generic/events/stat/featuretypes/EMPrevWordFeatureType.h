...
#ifndef EM_PREV_WORD_FEATURE_TYPE_H
#define EM_PREV_WORD_FEATURE_TYPE_H
...
class EMPrevWordFeatureType : public EventModalityFeatureType {
public:
	EMPrevWordFeatureType() : EventModalityFeatureType(Symbol(L"prev-word")) {}
