...
#ifndef ET_PREV_WC12_FEATURE_TYPE_H
#define ET_PREV_WC12_FEATURE_TYPE_H
...
class ETPrevWC12FeatureType : public EventTriggerFeatureType {
public:
	ETPrevWC12FeatureType() : EventTriggerFeatureType(Symbol(L"prev-wc12")) {}
