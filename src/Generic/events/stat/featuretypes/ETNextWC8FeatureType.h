...
#ifndef ET_NEXT_WC8_FEATURE_TYPE_H
#define ET_NEXT_WC8_FEATURE_TYPE_H
...
class ETNextWC8FeatureType : public EventTriggerFeatureType {
public:
	ETNextWC8FeatureType() : EventTriggerFeatureType(Symbol(L"next-wc8")) {}
