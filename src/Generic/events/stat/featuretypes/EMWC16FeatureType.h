...
#ifndef EM_WC16_FEATURE_TYPE_H
#define EM_WC16_FEATURE_TYPE_H
...
class EMWC16FeatureType : public EventModalityFeatureType {
public:
	EMWC16FeatureType() : EventModalityFeatureType(Symbol(L"wc16")) {}
