...
#ifndef EM_IS_PREMOD_OF_MENT_H
#define EM_IS_PREMOD_OF_MENT_H
...
class isPremodOfMention : public EventModalityFeatureType {

public:
	isPremodOfMention() : EventModalityFeatureType(Symbol(L"is-premod-of-mention")) {}
