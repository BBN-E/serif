...
#ifndef EM_IS_PREMOD_OF_NP_H
#define EM_IS_PREMOD_OF_NP_H
...
class isPremodOfNP : public EventModalityFeatureType {

public:
	isPremodOfNP() : EventModalityFeatureType(Symbol(L"is-premod-of-np")) {}
