...
#ifndef EM_IS_NONASSERTED_BY_RULES_H
#define EM_IS_NONASSERTED_BY_RULES_H
...
class isNonAssertedByRules : public EventModalityFeatureType {

public:
	isNonAssertedByRules() : EventModalityFeatureType(Symbol(L"is-nonasserted-by-rules")) {}
