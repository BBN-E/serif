...
#ifndef EM_HAS_NONASSERTED_INDICATOR_NOUN_H
#define EM_HAS_NONASSERTED_INDICATOR_NOUN_H
...
class hasNonAssertedIndicatorNoun : public EventModalityFeatureType {

public:
	hasNonAssertedIndicatorNoun() : EventModalityFeatureType(Symbol(L"has-nonasserted-indicator-noun")) {}
								...
								DTFeature **resultArray) const
	{
		...
		// option 1
		if (o->hasIndicatorsModifyingNoun()){
