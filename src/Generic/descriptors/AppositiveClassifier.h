...
#ifndef APPOSITIVE_CLASSIFIER_H
#define APPOSITIVE_CLASSIFIER_H

#include "Generic/descriptors/MentionClassifier.h"
#include "Generic/descriptors/CompoundMentionFinder.h"
/** Appositive Classifier - Deterministically make a node Appositive
 * 
 */
class AppositiveClassifier : public MentionClassifier {
public:
	AppositiveClassifier();
	virtual ~AppositiveClassifier();
