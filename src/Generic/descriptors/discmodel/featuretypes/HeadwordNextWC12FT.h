...
#ifndef HEADWORD_NEXT_WC_12_FT_H
#define HEADWORD_NEXT_WC_12_FT_H
...
class HeadwordNextWC12FT : public P1DescFeatureType {
public:
	HeadwordNextWC12FT() : P1DescFeatureType(Symbol(L"headword-next-wc-12")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(isClusterableWord(nextword)){
			...
			resultArray[nfeatures++] = _new DTIntFeature(this, state.getTag(), nextWC.c12());
		}
