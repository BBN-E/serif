...
#ifndef HEADWORD_NEXT_WC_8_FT_H
#define HEADWORD_NEXT_WC_8_FT_H
...
class HeadwordNextWC8FT : public P1DescFeatureType {
public:
	HeadwordNextWC8FT() : P1DescFeatureType(Symbol(L"headword-next-wc-8")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(isClusterableWord(nextword)){
			...
			resultArray[nfeatures++] = _new DTIntFeature(this, state.getTag(), nextWC.c8());
		}
