...
#ifndef HEADWORD_NEXT_WC_20_FT_H
#define HEADWORD_NEXT_WC_20_FT_H
...
class HeadwordNextWC20FT : public P1DescFeatureType {
public:
	HeadwordNextWC20FT() : P1DescFeatureType(Symbol(L"headword-next-wc-20")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if(isClusterableWord(nextword)){
			...
			resultArray[nfeatures++] = _new DTIntFeature(this, state.getTag(), nextWC.c20());
		}
