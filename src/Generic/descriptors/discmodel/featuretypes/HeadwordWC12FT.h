...
#ifndef HEADWORD_WC_12_FT_H
#define HEADWORD_WC_12_FT_H
...
class HeadwordWC12FT : public P1DescFeatureType {
public:
	HeadwordWC12FT() : P1DescFeatureType(Symbol(L"headword-wc-12")) {}
