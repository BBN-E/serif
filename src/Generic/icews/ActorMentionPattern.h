...
private:
	...
	bool _isDictionaryActor;
	bool _isNotDictionaryActor;
	Pattern_ptr _mention;
	Pattern_ptr _blockMention;
	bool _use_awake_db_for_icews;
...
private:
	...
	BOOST_MAKE_SHARED_2ARG_CONSTRUCTOR(ActorMentionReturnPFeature, Pattern_ptr, ActorMention_ptr);
public:
