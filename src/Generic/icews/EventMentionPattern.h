...
private:
	...
	std::set<Symbol> _patternId;
	std::set<Symbol> _blockPatternId;
	...
	std::vector<std::set<Symbol> > _sameCountrySets;
	std::vector<std::set<Symbol> > _blockSameCountrySets;
	...
	Pattern_ptr _firstPropPattern;

	/*********************************************************************
	 * Helper methods
	 *********************************************************************/
	bool actorsAreTheSame(ICEWSEventMention_ptr em, const std::set<Symbol> &roles);
	bool countriesAreTheSame(ICEWSEventMention_ptr em, const std::set<Symbol> &roles, ActorInfo_ptr actorInfo);
...
private:
	...
	BOOST_MAKE_SHARED_2ARG_CONSTRUCTOR(ICEWSEventMentionReturnPFeature, Pattern_ptr, ICEWSEventMention_ptr);
public:
...
private:
	...
	BOOST_MAKE_SHARED_2ARG_CONSTRUCTOR(ICEWSEventMentionPFeature, Pattern_ptr, ICEWSEventMention_ptr);
public:
	ICEWSEventMention_ptr getEventMention() const { return _eventMention; }
...
typedef boost::shared_ptr<ICEWSEventMentionMatchingPattern> ICEWSEventMentionMatchingPattern_ptr;
