...
#ifndef D_T_NPCHUNK_PREV_WC16_FEATURE_TYPE_H
#define D_T_NPCHUNK_PREV_WC16_FEATURE_TYPE_H
...
class NPChunkPrevWC16FeatureType : public PNPChunkFeatureType {
public:
	NPChunkPrevWC16FeatureType() : PNPChunkFeatureType(Symbol(L"prev-wc16"), InfoSource::OBSERVATION) {}
