...
#ifndef D_T_NPCHUNK_P1POS_FEATURE_TYPE_H
#define D_T_NPCHUNK_P1POS_FEATURE_TYPE_H
...
class NPChunkP1POSFeatureType : public PNPChunkFeatureType {
public:
	NPChunkP1POSFeatureType() : PNPChunkFeatureType(Symbol(L"pos-1"), InfoSource::OBSERVATION) {}
