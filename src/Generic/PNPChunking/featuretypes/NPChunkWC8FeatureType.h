...
#ifndef D_T_NPCHUNK_WC8_FEATURE_TYPE_H
#define D_T_NPCHUNK_WC8_FEATURE_TYPE_H
...
class NPChunkWC8FeatureType : public PNPChunkFeatureType {
public:
	NPChunkWC8FeatureType() : PNPChunkFeatureType(Symbol(L"wc8"), InfoSource::OBSERVATION) {}
