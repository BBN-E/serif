...
#ifndef D_T_NPCHUNK_P2WORD_FEATURE_TYPE_H
#define D_T_NPCHUNK_P2WORD_FEATURE_TYPE_H
...
class NPChunkP2WordFeatureType : public PNPChunkFeatureType {
public:
	NPChunkP2WordFeatureType() : PNPChunkFeatureType(Symbol(L"word-2"), InfoSource::OBSERVATION) {}
