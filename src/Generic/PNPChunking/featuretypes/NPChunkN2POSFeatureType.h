...
#ifndef D_T_NPCHUNK_N2POS_FEATURE_TYPE_H
#define D_T_NPCHUNK_N2POS_FEATURE_TYPE_H
...
class NPChunkN2POSFeatureType : public PNPChunkFeatureType {
public:
	NPChunkN2POSFeatureType() : PNPChunkFeatureType(Symbol(L"pos+2"), InfoSource::OBSERVATION) {}
