...
#ifndef D_T_NPCHUNK_N1POS_POS_FEATURE_TYPE_H
#define D_T_NPCHUNK_N1POS_POS_FEATURE_TYPE_H
...
class NPChunkN1POS_POSFeatureType : public PNPChunkFeatureType {
public:
	NPChunkN1POS_POSFeatureType() : PNPChunkFeatureType(Symbol(L"pos,pos+1"), InfoSource::OBSERVATION) {}
								...
								DTFeature **resultArray) const
	{
		...
		resultArray[0] = _new DTTrigramFeature(this, state.getTag(), o->getPOS(), o_1->getPOS());
		return 1;
	}
