...
#ifndef D_T_NPCHUNK_PREV_WC12_FEATURE_TYPE_H
#define D_T_NPCHUNK_PREV_WC12_FEATURE_TYPE_H
...
class NPChunkPrevWC12FeatureType : public PNPChunkFeatureType {
public:
	NPChunkPrevWC12FeatureType() : PNPChunkFeatureType(Symbol(L"prev-wc12"), InfoSource::OBSERVATION) {}
