...
#ifndef D_T_NPCHUNK_PREVWORD_FEATURE_TYPE_H
#define D_T_NPCHUNK_PREVWORD_FEATURE_TYPE_H
...
class NPChunkPrevWordFeatureType : public PNPChunkFeatureType {
public:
	NPChunkPrevWordFeatureType() : PNPChunkFeatureType(Symbol(L"prev-word"), InfoSource::OBSERVATION) {}
