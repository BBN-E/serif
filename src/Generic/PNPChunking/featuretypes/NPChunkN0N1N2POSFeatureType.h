...
#ifndef D_T_NPCHUNK_N0N1N2POS_FEATURE_TYPE_H
#define D_T_NPCHUNK_N0N1N2POS_FEATURE_TYPE_H
...
class NPChunkN0N1N2POSFeatureType : public PNPChunkFeatureType {
public:
	NPChunkN0N1N2POSFeatureType() : PNPChunkFeatureType(Symbol(L"pos,pos+1,pos+2"), InfoSource::OBSERVATION) {}
								...
								DTFeature **resultArray) const
	{
		...
		TokenPOSObservation *o_1= static_cast<TokenPOSObservation*>(
			...
			state.getObservation(state.getIndex()));
				resultArray[0] = _new DTQuadgramFeature(this, state.getTag(), o->getPOS(), 
					o_1->getPOS(), o_2->getPOS());
		return 1;
	}
