...
#ifndef WORDS_BETWEEN_TYPES_FT_H
#define WORDS_BETWEEN_TYPES_FT_H
...
class WordsBetweenTypesFT : public P1RelationFeatureType {
public:
	WordsBetweenTypesFT() : P1RelationFeatureType(Symbol(L"wb-entity-types")) {}
