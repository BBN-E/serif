...
#ifndef EL_SAME_ARG_FEATURE_TYPE_H
#define EL_SAME_ARG_FEATURE_TYPE_H
...
class ELSameArgFeatureType : public EventLinkFeatureType {
public:
	ELSameArgFeatureType() : EventLinkFeatureType(Symbol(L"same-arg")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if (discard) {
				SessionLogger::warn("DT_feature_limit") 
					<<"ELSameArgFeatureType discarding features beyond MAX_FEATURES_PER_EXTRACTION\n";
		}
