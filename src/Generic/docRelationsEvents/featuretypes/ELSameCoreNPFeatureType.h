...
#ifndef EL_SAME_CORE_NP_FEATURE_TYPE_H
#define EL_SAME_CORE_NP_FEATURE_TYPE_H
...
class ELSameCoreNPFeatureType : public EventLinkFeatureType {
public:
	ELSameCoreNPFeatureType() : EventLinkFeatureType(Symbol(L"same-core-np")) {}
