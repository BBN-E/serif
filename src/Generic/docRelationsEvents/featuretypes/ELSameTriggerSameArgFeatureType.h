...
#ifndef EL_SAME_TRIGGER_SAME_ARG_FEATURE_TYPE_H
#define EL_SAME_TRIGGER_SAME_ARG_FEATURE_TYPE_H
...
class ELSameTriggerSameArgFeatureType : public EventLinkFeatureType {
public:
	ELSameTriggerSameArgFeatureType() : EventLinkFeatureType(Symbol(L"same-trigger-same-arg")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if (discard){
			SessionLogger::warn("DT_feature_limit") 
				<<"ELSameTriggerSameArgFeatureType discarding features beyond MAX_FEATURES_PER_EXTRACTION\n";
		}
		return count;
	}
};
