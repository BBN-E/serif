...
#ifndef EL_SAME_ARG_HW_RED_FEATURE_TYPE_H
#define EL_SAME_ARG_HW_RED_FEATURE_TYPE_H
...
class ELSameArgHWRedFeatureType : public EventLinkFeatureType {
public:
	ELSameArgHWRedFeatureType() : EventLinkFeatureType(Symbol(L"same-arg-headword-red")) {}
