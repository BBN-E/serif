...
#ifndef TA_CONNECTING_STRING_FEATURE_TYPE_H
#define TA_CONNECTING_STRING_FEATURE_TYPE_H
...
class TAConnectingStringFeatureType : public RelationTimexArgFeatureType {
public:
	TAConnectingStringFeatureType() :RelationTimexArgFeatureType(Symbol(L"connecting-string")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if (o->getConnectingString() == L"")
			return 0;

		resultArray[0] = _new DTBigramStringFeature(this, state.getTag(), 
			o->getRelationType(), o->getConnectingString());
		return 1;
	}
};
