...
#ifndef D_T_PART_OF_SPEECH_NEXT_WC20_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_NEXT_WC20_FEATURE_TYPE_H
...
class PartOfSpeechNextWC20FeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechNextWC20FeatureType() : PPartOfSpeechFeatureType(Symbol(L"next-wc20"), InfoSource::OBSERVATION) {}
