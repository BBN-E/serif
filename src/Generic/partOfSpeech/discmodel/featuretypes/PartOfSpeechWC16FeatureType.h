...
#ifndef D_T_PART_OF_SPEECH_WC16_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_WC16_FEATURE_TYPE_H
...
class PartOfSpeechWC16FeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechWC16FeatureType() : PPartOfSpeechFeatureType(Symbol(L"wc16"), InfoSource::OBSERVATION) {}
