...
#ifndef D_T_PART_OF_SPEECH_NEXT_WC12_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_NEXT_WC12_FEATURE_TYPE_H
...
class PartOfSpeechNextWC12FeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechNextWC12FeatureType() : PPartOfSpeechFeatureType(Symbol(L"next-wc12"), InfoSource::OBSERVATION) {}
