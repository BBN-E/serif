...
#ifndef D_T_PART_OF_SPEECH_PREVWORD_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_PREVWORD_FEATURE_TYPE_H
...
class PartOfSpeechPrevWordFeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechPrevWordFeatureType() : PPartOfSpeechFeatureType(Symbol(L"prev-word"), InfoSource::OBSERVATION) {}
