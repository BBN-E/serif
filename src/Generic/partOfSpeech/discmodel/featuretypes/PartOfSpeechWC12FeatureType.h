...
#ifndef D_T_PART_OF_SPEECH_WC12_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_WC12_FEATURE_TYPE_H
...
class PartOfSpeechWC12FeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechWC12FeatureType() : PPartOfSpeechFeatureType(Symbol(L"wc12"), InfoSource::OBSERVATION) {}
