...
#ifndef D_T_PART_OF_SPEECH_PREV_WC8_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_PREV_WC8_FEATURE_TYPE_H
...
class PartOfSpeechPrevWC8FeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechPrevWC8FeatureType() : PPartOfSpeechFeatureType(Symbol(L"prev-wc8"), InfoSource::OBSERVATION) {}
