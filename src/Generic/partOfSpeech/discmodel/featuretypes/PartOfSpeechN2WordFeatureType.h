...
#ifndef D_T_PART_OF_SPEECH_N2WORD_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_N2WORD_FEATURE_TYPE_H
...
class PartOfSpeechN2WordFeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechN2WordFeatureType() : PPartOfSpeechFeatureType(Symbol(L"word+2"), InfoSource::OBSERVATION) {}
