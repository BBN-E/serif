...
#ifndef D_T_PART_OF_SPEECH_NEXT_WC16_FEATURE_TYPE_H
#define D_T_PART_OF_SPEECH_NEXT_WC16_FEATURE_TYPE_H
...
class PartOfSpeechNextWC16FeatureType : public PPartOfSpeechFeatureType {
public:
	PartOfSpeechNextWC16FeatureType() : PPartOfSpeechFeatureType(Symbol(L"next-wc16"), InfoSource::OBSERVATION) {}
								...
								DTFeature **resultArray) const
	{
		if(state.getIndex()+1 >= state.getNObservations()){
			resultArray[0] = _new DTIntFeature(this, state.getTag(), blankWordClass.c16());
			return 1;
		}
