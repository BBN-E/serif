...
#ifndef EEML_RESULT_COLLECTOR_H
#define EEML_RESULT_COLLECTOR_H
...
class EEMLResultCollector : public ResultCollector {
public:
	EEMLResultCollector() 
...
private:
    ...
    serif::hash_map<MentionUID, bool, MentionUID::HashOp, MentionUID::EqualOp> _isValidMention;
