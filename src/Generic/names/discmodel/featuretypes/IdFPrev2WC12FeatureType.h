...
#ifndef D_T_PREV_2_WC12_FEATURE_TYPE_H
#define D_T_PREV_2_WC12_FEATURE_TYPE_H
...
class IdFPrev2WC12FeatureType : public PIdFFeatureType {
public:
	IdFPrev2WC12FeatureType() : PIdFFeatureType(Symbol(L"prev2-wc12"), InfoSource::OBSERVATION) {}
