...
#ifndef D_T_NEXT_WC20_FEATURE_TYPE_H
#define D_T_NEXT_WC20_FEATURE_TYPE_H
...
class IdFNextWC20FeatureType : public PIdFFeatureType {
public:
	IdFNextWC20FeatureType() : PIdFFeatureType(Symbol(L"next-wc20"), InfoSource::OBSERVATION) {}
