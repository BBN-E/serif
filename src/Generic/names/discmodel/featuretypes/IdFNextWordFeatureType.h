...
#ifndef D_T_NEXTWORD_FEATURE_TYPE_H
#define D_T_NEXTWORD_FEATURE_TYPE_H
...
class IdFNextWordFeatureType : public PIdFFeatureType {
public:
	IdFNextWordFeatureType() : PIdFFeatureType(Symbol(L"next-word"), InfoSource::OBSERVATION) {}
