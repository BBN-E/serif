...
#ifndef D_T_IDF_CENTERTRIGRAM_FEATURE_TYPE_H
#define D_T_IDF_CENTERTRIGRAM_FEATURE_TYPE_H
...
class IdFCenterTrigramFeatureType : public PIdFFeatureType {
public:
	IdFCenterTrigramFeatureType() : PIdFFeatureType(Symbol(L"centertrigram"), InfoSource::OBSERVATION) {}
