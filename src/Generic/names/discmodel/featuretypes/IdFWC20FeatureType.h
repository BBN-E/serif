...
#ifndef D_T_WC20_FEATURE_TYPE_H
#define D_T_WC20_FEATURE_TYPE_H
...
class IdFWC20FeatureType : public PIdFFeatureType {
public:
	IdFWC20FeatureType() : PIdFFeatureType(Symbol(L"wc20"), InfoSource::OBSERVATION) {}
