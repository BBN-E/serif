...
#ifndef D_T_NEXT_WC12_FEATURE_TYPE_H
#define D_T_NEXT_WC12_FEATURE_TYPE_H
...
class IdFNextWC12FeatureType : public PIdFFeatureType {
public:
	IdFNextWC12FeatureType() : PIdFFeatureType(Symbol(L"next-wc12"), InfoSource::OBSERVATION) {}
