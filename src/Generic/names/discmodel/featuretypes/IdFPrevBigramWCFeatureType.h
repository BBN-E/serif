...
#ifndef D_T_IDF_PREVBIGRAM_WC_FEATURE_TYPE_H
#define D_T_IDF_PREVBIGRAM_WC_FEATURE_TYPE_H
...
class IdFPrevBigramWCFeatureType : public PIdFFeatureType {
public:
	IdFPrevBigramWCFeatureType() : PIdFFeatureType(Symbol(L"prevbigram-wc"), InfoSource::OBSERVATION) {}
