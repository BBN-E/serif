...
#ifndef D_T_PREV_WC12_FEATURE_TYPE_H
#define D_T_PREV_WC12_FEATURE_TYPE_H
...
class IdFPrevWC12FeatureType : public PIdFFeatureType {
public:
	IdFPrevWC12FeatureType() : PIdFFeatureType(Symbol(L"prev-wc12"), InfoSource::OBSERVATION) {}
