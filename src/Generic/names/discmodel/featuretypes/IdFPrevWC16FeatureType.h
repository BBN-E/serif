...
#ifndef D_T_PREV_WC16_FEATURE_TYPE_H
#define D_T_PREV_WC16_FEATURE_TYPE_H
...
class IdFPrevWC16FeatureType : public PIdFFeatureType {
public:
	IdFPrevWC16FeatureType() : PIdFFeatureType(Symbol(L"prev-wc16"), InfoSource::OBSERVATION) {}
