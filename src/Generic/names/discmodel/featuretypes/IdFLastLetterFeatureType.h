...
#ifndef D_T_LASTLETTER_H
#define D_T_LASTLETTER_H
...
class IdFLastLetterFeatureType : public PIdFFeatureType {
public:
	IdFLastLetterFeatureType() : PIdFFeatureType(Symbol(L"idf-last-letter"), InfoSource::OBSERVATION) {}
