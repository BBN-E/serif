...
#ifndef D_T_IDF_PREV_TRIGRAM_WC_FEATURE_TYPE_H
#define D_T_IDF_PREV_TRIGRAM_WC_FEATURE_TYPE_H
...
class IdFPrevTrigramWCFeatureType : public PIdFFeatureType {
public:
	IdFPrevTrigramWCFeatureType() : PIdFFeatureType(Symbol(L"prevtrigram-wc"), InfoSource::OBSERVATION) {}
