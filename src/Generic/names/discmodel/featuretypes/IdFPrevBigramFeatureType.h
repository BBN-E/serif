...
#ifndef D_T_IDF_PREVBIGRAM_FEATURE_TYPE_H
#define D_T_IDF_PREVBIGRAM_FEATURE_TYPE_H
...
class IdFPrevBigramFeatureType : public PIdFFeatureType {
public:
	IdFPrevBigramFeatureType() : PIdFFeatureType(Symbol(L"prevbigram"), InfoSource::OBSERVATION) {}
