...
#ifndef D_T_NEXT_WC8_FEATURE_TYPE_H
#define D_T_NEXT_WC8_FEATURE_TYPE_H
...
class IdFNextWC8FeatureType : public PIdFFeatureType {
public:
	IdFNextWC8FeatureType() : PIdFFeatureType(Symbol(L"next-wc8"), InfoSource::OBSERVATION) {}
