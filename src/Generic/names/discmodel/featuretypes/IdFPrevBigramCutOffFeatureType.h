...
#ifndef D_T_IDF_PREVBIGRAM_WITH_CUTT_OFF_FEATURE_TYPE_H
#define D_T_IDF_PREVBIGRAM_WITH_CUTT_OFF_FEATURE_TYPE_H
...
class IdFPrevBigramCutOffFeatureType : public PIdFFeatureType {
public:
	Symbol* _bigram;

	IdFPrevBigramCutOffFeatureType() : PIdFFeatureType(Symbol(L"prevbigram_with_cuttoff"), InfoSource::OBSERVATION) {
