...
#ifndef D_T_NEXT_2_WC20_FEATURE_TYPE_H
#define D_T_NEXT_2_WC20_FEATURE_TYPE_H
...
class IdFNext2WC20FeatureType : public PIdFFeatureType {
public:
	IdFNext2WC20FeatureType() : PIdFFeatureType(Symbol(L"next2-wc20"), InfoSource::OBSERVATION) {}
