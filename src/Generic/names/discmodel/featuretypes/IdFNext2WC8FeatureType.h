...
#ifndef D_T_NEXT_2_WC8_FEATURE_TYPE_H
#define D_T_NEXT_2_WC8_FEATURE_TYPE_H
...
class IdFNext2WC8FeatureType : public PIdFFeatureType {
public:
	IdFNext2WC8FeatureType() : PIdFFeatureType(Symbol(L"next2-wc8"), InfoSource::OBSERVATION) {}
