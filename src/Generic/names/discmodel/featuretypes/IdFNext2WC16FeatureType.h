...
#ifndef D_T_NEXT_2_WC16_FEATURE_TYPE_H
#define D_T_NEXT_2_WC16_FEATURE_TYPE_H
...
class IdFNext2WC16FeatureType : public PIdFFeatureType {
public:
	IdFNext2WC16FeatureType() : PIdFFeatureType(Symbol(L"next2-wc16"), InfoSource::OBSERVATION) {}
