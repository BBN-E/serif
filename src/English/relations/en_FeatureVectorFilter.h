...
#ifndef EN_FEATUREVECTORFILTER_H
#define EN_FEATUREVECTORFILTER_H
...
class EnglishFeatureVectorFilter : public RelationFilter {

public:
  EnglishFeatureVectorFilter() : RelationFilter(3) { 
