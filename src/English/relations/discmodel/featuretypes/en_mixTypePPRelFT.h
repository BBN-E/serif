...
#ifndef EN_MIXTYPE_PP_REL_FT_H
#define EN_MIXTYPE_PP_REL_FT_H
...
class EnglishMixTypePPRelFT : public P1RelationFeatureType {
public:
	EnglishMixTypePPRelFT() : P1RelationFeatureType(Symbol(L"mixtype-pp-relation")) {}
