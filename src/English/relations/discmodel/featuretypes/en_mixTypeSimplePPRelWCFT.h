...
#ifndef EN_MIXTYPE_SIMPLE_PP_REL_WC_FT_H
#define EN_MIXTYPE_SIMPLE_PP_REL_WC_FT_H
...
class EnglishMixTypeSimplePPRelWCFT : public P1RelationFeatureType {
public:
	EnglishMixTypeSimplePPRelWCFT() : P1RelationFeatureType(Symbol(L"mixtype-simple-pp-relation-wc")) {}
