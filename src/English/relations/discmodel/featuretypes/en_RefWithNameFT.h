...
#ifndef EN_REF_WITH_NAME_FT_H
#define EN_REF_WITH_NAME_FT_H
...
class EnglishRefWithNameFT : public P1RelationFeatureType {
public:
	EnglishRefWithNameFT() : P1RelationFeatureType(Symbol(L"ref-with-name")) {}
