...
#ifndef EN_POSSESSIVE_WC_FT_H
#define EN_POSSESSIVE_WC_FT_H
...
class EnglishPossessiveWCFT : public P1RelationFeatureType {
public:
	EnglishPossessiveWCFT() : P1RelationFeatureType(Symbol(L"poss-wc")) {}
