...
#ifndef EN_VTYPE_SIMPLE_PP_REL_FT_H
#define EN_VTYPE_SIMPLE_PP_REL_FT_H
...
class EnglishVTypeSimplePPRelFT : public P1RelationFeatureType {
public:
	EnglishVTypeSimplePPRelFT() : P1RelationFeatureType(Symbol(L"vtype-simple-pp-relation")) {}
