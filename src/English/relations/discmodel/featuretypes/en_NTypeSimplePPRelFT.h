...
#ifndef EN_NTYPE_SIMPLE_PP_REL_FT_H
#define EN_NTYPE_SIMPLE_PP_REL_FT_H
...
class EnglishNTypeSimplePPRelFT : public P1RelationFeatureType {
public:
	EnglishNTypeSimplePPRelFT() : P1RelationFeatureType(Symbol(L"ntype-simple-pp-relation")) {}
