...
#ifndef EN_SIMPLE_PROP_FT_H
#define EN_SIMPLE_PROP_FT_H
...
class EnglishSimplePropFT : public P1RelationFeatureType {
public:
	EnglishSimplePropFT() : P1RelationFeatureType(Symbol(L"simple-prop")) {}
