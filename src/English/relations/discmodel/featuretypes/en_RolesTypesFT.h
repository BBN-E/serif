...
#ifndef EN_ROLES_TYPES_FT_H
#define EN_ROLES_TYPES_FT_H
...
class EnglishRolesTypesFT : public P1RelationFeatureType {
public:
	EnglishRolesTypesFT() : P1RelationFeatureType(Symbol(L"roles-types")) {}
