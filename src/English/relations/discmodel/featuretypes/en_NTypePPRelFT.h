...
#ifndef EN_NTYPE_PP_REL_FT_H
#define EN_NTYPE_PP_REL_FT_H
...
class EnglishNTypePPRelFT : public P1RelationFeatureType {
public:
	EnglishNTypePPRelFT() : P1RelationFeatureType(Symbol(L"ntype-pp-relation")) {}
