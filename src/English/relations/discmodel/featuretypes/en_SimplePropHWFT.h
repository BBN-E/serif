...
#ifndef EN_SIMPLE_PROP_HW_FT_H
#define EN_SIMPLE_PROP_HW_FT_H
...
class EnglishSimplePropHWFT : public P1RelationFeatureType {
public:
	EnglishSimplePropHWFT() : P1RelationFeatureType(Symbol(L"simple-prop-hw")) {}
