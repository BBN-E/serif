...
#ifndef EN_SIMPLE_PROP_WC_FT_H
#define EN_SIMPLE_PROP_WC_FT_H
...
class EnglishSimplePropWCFT : public P1RelationFeatureType {
public:
	EnglishSimplePropWCFT() : P1RelationFeatureType(Symbol(L"simple-prop-wc")) {}
