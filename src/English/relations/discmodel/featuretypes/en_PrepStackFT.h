...
#ifndef EN_PREP_STACK_FT_H
#define EN_PREP_STACK_FT_H
...
class EnglishPrepStackFT : public P1RelationFeatureType {
public:
	EnglishPrepStackFT() : P1RelationFeatureType(Symbol(L"prep-stack")) {}
