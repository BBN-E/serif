...
#ifndef EN_SIMPLE_PP_REL_FT_H
#define EN_SIMPLE_PP_REL_FT_H
...
class EnglishSimplePPRelFT : public P1RelationFeatureType {
public:
	EnglishSimplePPRelFT() : P1RelationFeatureType(Symbol(L"simple-pp-relation")) {}
