...
#ifndef EN_MIXTYPE_PP_REL_WC_FT_H
#define EN_MIXTYPE_PP_REL_WC_FT_H
...
class EnglishMixTypePPRelWCFT : public P1RelationFeatureType {
public:
	EnglishMixTypePPRelWCFT() : P1RelationFeatureType(Symbol(L"mixtype-pp-relation-wc")) {}
