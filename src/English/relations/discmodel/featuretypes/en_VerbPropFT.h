...
#ifndef EN_VERB_PROP_FT_H
#define EN_VERB_PROP_FT_H
...
class EnglishVerbPropFT : public P1RelationFeatureType {
public:
	EnglishVerbPropFT() : P1RelationFeatureType(Symbol(L"verb-prop")) {}
