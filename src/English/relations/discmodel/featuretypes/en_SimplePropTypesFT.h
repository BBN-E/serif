...
#ifndef EN_SIMPLE_PROP_TYPES_FT_H
#define EN_SIMPLE_PROP_TYPES_FT_H
...
class EnglishSimplePropTypesFT : public P1RelationFeatureType {
public:
	EnglishSimplePropTypesFT() : P1RelationFeatureType(Symbol(L"simple-prop-types")) {}
