...
#include "English/relations/en_MaxEntRelationFinder.h"
...
UTF8OutputStream EnglishMaxEntRelationFinder::_debugStream;
bool EnglishMaxEntRelationFinder::DEBUG = false;

EnglishMaxEntRelationFinder::EnglishMaxEntRelationFinder() {
	...
	if (!ParamReader::getParam("relation_tag_set_file",tag_set_file,		500))	{
		throw UnexpectedInputException("EnglishMaxEntRelationFinder::EnglishMaxEntRelationFinder()",
...
void EnglishMaxEntRelationFinder::resetForNewSentence() {
	_n_relations = 0;
}

RelMentionSet *EnglishMaxEntRelationFinder::getRelationTheory(const Parse *parse,
...
void EnglishMaxEntRelationFinder::addRelation(const Mention *first, const Mention *second, Symbol type) {
...
bool EnglishMaxEntRelationFinder::fixRelation(const Mention *first, const Mention *second, Symbol type) {
...
void EnglishMaxEntRelationFinder::tryForcingRelations(MentionSet *mentionSet) {
...
bool EnglishMaxEntRelationFinder::tryFakeTypeRelation(MentionSet *mentionSet,
...
/*bool EnglishMaxEntRelationFinder::tryCoercedTypeRelation(MentionSet *mentionSet, EntitySet *entitySet,
												 const Mention *possMention,
												 EntityType possibleType)
{
	EntityType origType = possMention->getEntityType();
...
bool EnglishMaxEntRelationFinder::shouldBeReversed(Symbol answer) {
...
void EnglishMaxEntRelationFinder::loadSymbolHash(SymbolHash *hash, const char* file) {
