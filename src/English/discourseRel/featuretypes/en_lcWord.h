...
#ifndef en_lowerCase_Word_H
#define en_lowerCase_Word_H
...
class EnglishLcWord : public DiscourseRelFeatureType {

public:
	EnglishLcWord() : DiscourseRelFeatureType(Symbol(L"lowerCase_Word")) {
