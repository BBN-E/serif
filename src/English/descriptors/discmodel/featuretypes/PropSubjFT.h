...
#ifndef EN_PROP_SUBJ_DISC_FT_H
#define EN_PROP_SUBJ_DISC_FT_H
...
class EnglishPropSubjFT : public P1DescFeatureType {
public:
	EnglishPropSubjFT() : P1DescFeatureType(Symbol(L"subj-prop")) {}
								...
								DTFeature **resultArray) const
	{
		...
		if (discard) {
			SessionLogger::warn("DT_feature_limit") <<"EnglishPropSubjFT discarding features beyond MAX_FEATURES_PER_EXTRACTION\n";
		}
		return n_results;
