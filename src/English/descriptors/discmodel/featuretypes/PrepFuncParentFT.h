...
#ifndef EN_PREP_FUNC_PARENT_FT_H
#define EN_PREP_FUNC_PARENT_FT_H
...
class EnglishPrepFuncParentFT : public P1DescFeatureType {
public:
	EnglishPrepFuncParentFT() : P1DescFeatureType(Symbol(L"prep-func-parent")) {}
	...
	//for prepositions, its easier to get from parse than proposition set
		...
		if(parent->getTag() != EnglishSTags::PP){
			return 0;
		}
