...
#ifndef EN_PERSON_HYPONYM_FT_H
#define EN_PERSON_HYPONYM_FT_H
...
class EnglishPersonHyponymFT : public P1DescFeatureType {
public:
	EnglishPersonHyponymFT() : P1DescFeatureType(Symbol(L"person-hyponym")) {}
