...
#ifndef en_RULE_NAME_LINKER_H
#define en_RULE_NAME_LINKER_H
 ...
 */
/** NOTE: This is a stub file to be filled in with the real EnglishRuleNameLinker
*/
class EnglishRuleNameLinker : public RuleNameLinker {
private:
	friend class EnglishRuleNameLinkerFactory;
...
class EnglishRuleNameLinkerFactory: public RuleNameLinker::Factory {
	virtual RuleNameLinker *build() { return _new EnglishRuleNameLinker(); }
};
