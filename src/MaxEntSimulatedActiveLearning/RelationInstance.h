...
#ifndef RELATION_INSTANCE_H
#define RELATION_INSTANCE_H
...
public:
	...
	RelationInstance(int index1, int index2, 
	...
	bool operator<(RelationInstance& other) const {
...
private:
	...
	Symbol _annoSym;
	Symbol _uid;  // should be unique for every RelationInstance
	Symbol _docID;
};
