...
#ifndef CH_PROP_IOBJ_DISC_FT_H
#define CH_PROP_IOBJ_DISC_FT_H
...
class ChinesePropIObjFT : public P1DescFeatureType {
public:
	ChinesePropIObjFT() : P1DescFeatureType(Symbol(L"iobj-prop")) {}
