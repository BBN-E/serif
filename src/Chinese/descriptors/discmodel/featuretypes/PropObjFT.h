...
#ifndef CH_PROP_OBJ_DISC_FT_H
#define CH_PROP_OBJ_DISC_FT_H
...
class ChinesePropObjFT : public P1DescFeatureType {
public:
	ChinesePropObjFT() : P1DescFeatureType(Symbol(L"obj-prop")) {}
