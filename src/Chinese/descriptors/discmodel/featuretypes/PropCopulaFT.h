...
#ifndef CH_PROP_COPULA_DISC_FT_H
#define CH_PROP_COPULA_DISC_FT_H
...
class ChinesePropCopulaFT : public P1DescFeatureType {
public:
	ChinesePropCopulaFT() : P1DescFeatureType(Symbol(L"copula-prop")) {}
