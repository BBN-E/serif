...
#ifndef ch_DESCLINKFUNCTIONS_H
#define ch_DESCLINKFUNCTIONS_H

#include "Generic/edt/DescLinkFunctions.h"
#include "Generic/common/hash_map.h"
#include "Generic/common/SymbolHash.h"

class ChineseDescLinkFunctions : public DescLinkFunctions {
private:
	friend class ChineseDescLinkFunctionsFactory;
...
private:
	...
	static bool _hasPremod(Mention* ment);
		// the following borrowed loosely from ch_DescLinker
...
class ChineseDescLinkFunctionsFactory: public DescLinkFunctions::Factory {
	virtual void getEventContext(EntitySet* entSet, Mention* mention, Entity* entity, OldMaxEntEvent* evt, int maxSize) {  ChineseDescLinkFunctions::getEventContext(entSet, mention, entity, evt, maxSize); }
};
