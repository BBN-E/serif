...
#ifndef CH_PL_TYPE_NUMBER_GENDER_HW_FT_H
#define CH_PL_TYPE_NUMBER_GENDER_HW_FT_H
...
class ChinesePLTypeNumberGenderHWFT : public DTCorefFeatureType {
public:
	ChinesePLTypeNumberGenderHWFT() : DTCorefFeatureType(Symbol(L"type-number-gender-hw")) {}
