...
#ifndef CH_PL_TYPE_NUMBER_GENDER_FT_H
#define CH_PL_TYPE_NUMBER_GENDER_FT_H
...
class ChinesePLTypeNumberGenderFT : public DTCorefFeatureType {
public:
	ChinesePLTypeNumberGenderFT() : DTCorefFeatureType(Symbol(L"type-number-gender")) {}
