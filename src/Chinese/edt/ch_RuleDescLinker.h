...
#ifndef ch_RULE_DESC_LINKER_H
#define ch_RULE_DESC_LINKER_H
 ...
 */
class ChineseRuleDescLinker : public RuleDescLinker {
private:
	friend class ChineseRuleDescLinkerFactory;
...
class ChineseRuleDescLinkerFactory: public RuleDescLinker::Factory {
	virtual RuleDescLinker *build() { return _new ChineseRuleDescLinker(); }
};
