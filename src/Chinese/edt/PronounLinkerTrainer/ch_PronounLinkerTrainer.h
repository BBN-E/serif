...
#ifndef ch_PRONOUNLINKERTRAINER_H
#define ch_PRONOUNLINKERTRAINER_H
...
class ChinesePronounLinkerTrainer : public PronounLinkerTrainer {
public:
	ChinesePronounLinkerTrainer();
	~ChinesePronounLinkerTrainer();
