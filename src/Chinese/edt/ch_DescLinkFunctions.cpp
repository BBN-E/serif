...
ChineseDescLinkFunctions::WordClusterTable *ChineseDescLinkFunctions::_clusterTable = 0;
SymbolHash *ChineseDescLinkFunctions::_stopWords = 0;
const int initialTableSize = 16000;
const int numClusters = 4;

void ChineseDescLinkFunctions::getEventContext(EntitySet* entSet, Mention* mention,
...
Symbol ChineseDescLinkFunctions::_findMentHeadWord(Mention *ment) {
...
bool ChineseDescLinkFunctions::_testHeadWordMatch(Mention *ment, Entity *entity, EntitySet *entitySet) {
	Symbol headWord = ment->getNode()->getHeadWord();
...
bool ChineseDescLinkFunctions::_testHeadWordNodeMatch(Mention *ment, Entity *entity, EntitySet *entitySet) {
...
bool ChineseDescLinkFunctions::_lastHanziMatch(Mention *ment, Entity *entity, EntitySet *entitySet) {
...
Symbol ChineseDescLinkFunctions::_getUniqueHanziRatio(Mention *ment, Entity *entity, EntitySet *entitySet) {
...
// recalculating.  Also should add stop words.
Symbol ChineseDescLinkFunctions::_getUniqueModifierRatio(Mention *ment, Entity *entity, EntitySet *entitySet) {
...
Symbol ChineseDescLinkFunctions::_getDistance(int sent_num, Entity *entity, EntitySet *entitySet) {
...
bool ChineseDescLinkFunctions::_exactStringMatch(Mention *ment, Entity *entity, EntitySet *entitySet) {
...
int ChineseDescLinkFunctions::_getHeadNPWords(const SynNode* node, Symbol results[], int max_results) {
...
bool ChineseDescLinkFunctions::_entHasNumeric(Entity *ent, EntitySet *entitySet) {
...
bool ChineseDescLinkFunctions::_mentHasNumeric(Mention *ment) {
...
bool ChineseDescLinkFunctions::_hasNumericClash(Mention *ment, Entity *ent, EntitySet *entitySet)
{
...
bool ChineseDescLinkFunctions::_hasNumericMatch(Mention *ment, Entity *ent, EntitySet *entitySet)
{
	GrowableArray<const SynNode*> numerics;
	for (int i = 0; i < ent->getNMentions(); i++) {
		Mention *prev = entitySet->getMention(ent->getMention(i));
...
const SynNode* ChineseDescLinkFunctions::_getNumericPremod(Mention *ment) {
...
bool ChineseDescLinkFunctions::_hasPremodName(Mention* ment, EntitySet* ents)
{
...
bool ChineseDescLinkFunctions::_hasPremod(Mention* ment)
{
...
// don't bother
Symbol ChineseDescLinkFunctions::_getParentHead(Mention* ment) {
	const SynNode* node = ment->node;
	...
	while (node->getParent() != NULL) {
		...
		if (headWord != mentHead &&
			(headNode->getTag() == ChineseSTags::VA ||
			 headNode->getTag() == ChineseSTags::VC ||
			 headNode->getTag() == ChineseSTags::VCD ||
			 headNode->getTag() == ChineseSTags::VCP ||
			 headNode->getTag() == ChineseSTags::VE ||
			 headNode->getTag() == ChineseSTags::VNV ||
			 headNode->getTag() == ChineseSTags::VP ||
			 headNode->getTag() == ChineseSTags::VPT ||
			 headNode->getTag() == ChineseSTags::VRD ||
			 headNode->getTag() == ChineseSTags::VSB ||
			 headNode->getTag() == ChineseSTags::VV)) {
				 return headWord;
			 }
			 node = node->getParent();
	}
...
Symbol ChineseDescLinkFunctions::_findMentParent(Mention* ment) {
...
int ChineseDescLinkFunctions::_findEntParents(Entity* ent, EntitySet* ents, Symbol *results, const int max_results) {
...
int ChineseDescLinkFunctions::_findMentPremods(Mention* ment, Symbol *premods, const int max_results) {
...
int ChineseDescLinkFunctions::_findEntHeadWords(Entity* ent, EntitySet* ents, Symbol *results, const int max_results) {
	int n_results = 0;
...
int ChineseDescLinkFunctions::_findEntPremods(Entity* ent, EntitySet* ents, Symbol *results, const int max_results) {
...
int ChineseDescLinkFunctions::_getPremodNames(Mention* ment, EntitySet* ents,
...
int ChineseDescLinkFunctions::_getPremods(Mention* ment, Symbol results[],
										const int max_results)
{
	if (max_results < 1)
		return 0;
...
int ChineseDescLinkFunctions::_getMentionInternalNames(const SynNode* node,
												const MentionSet* ms,
												const SynNode* results[],
												const int max_results)
{
...
bool ChineseDescLinkFunctions::_hasPremodNameEntityClash(Mention* ment, Entity* ent, EntitySet* ents)
{
...
bool ChineseDescLinkFunctions::_hasPremodClash(Mention* ment, Entity* ent, EntitySet* ents) {
	if (ment == 0 || ent == 0)
		return false;
	const int MAX_PREMODS = 5;
...
bool ChineseDescLinkFunctions::_hasPremodMatch(Mention* ment, Entity* ent, EntitySet* ents) {
	if (ment == 0 || ent == 0)
		return false;
	const int MAX_PREMODS = 5;
	Symbol ment1Premods[MAX_PREMODS];
...
Symbol ChineseDescLinkFunctions::_getNumEnts(EntityType type, EntitySet *set) {
...
bool ChineseDescLinkFunctions::_entityContainsOnlyNames(Entity *entity, EntitySet *entitySet) {
...
bool ChineseDescLinkFunctions::_mentOverlapsEntity(Mention *mention, Entity *entity, EntitySet *entSet) {
...
Symbol ChineseDescLinkFunctions::_getClusterScore(Mention *ment, Entity *ent, EntitySet *entSet) {
...
bool ChineseDescLinkFunctions::_hasClusterMatch(Mention *ment, Entity *ent, EntitySet *entSet) {
	const int MAX_CLUSTERS = 4;
...
int ChineseDescLinkFunctions::_findMentClusters(Mention *ment, Symbol *results, const int max_results) {
	const int MAX_CLUSTERS = 4;
...
int ChineseDescLinkFunctions::_findEntClusters(Entity* ent, EntitySet* ents, Symbol *results, const int max_results) {
	const int MAX_CLUSTERS = 4;
	int n_results = 0;
...
int ChineseDescLinkFunctions::_getClusters(Symbol word, Symbol *results, const int max_results) {
	int n_clusters = 0;
...
Symbol ChineseDescLinkFunctions::_getCommonParent(Mention* ment, Entity* ent, EntitySet* ents) {
	wchar_t wordstr[300];
	for (int i = 0; i < ent->getNMentions(); i++) {
...
void ChineseDescLinkFunctions::initializeWordClusterTable() {
...
void ChineseDescLinkFunctions::initializeStopWords() {
	...
	stream >> size;
	if (size < 0)
		throw UnexpectedInputException("ChineseDescLinkFunctions::loadStopWords()",
