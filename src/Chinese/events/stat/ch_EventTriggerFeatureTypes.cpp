...
#include "Generic/events/stat/featuretypes/ETPrevTrigramFeatureType.h"
#include "Generic/events/stat/featuretypes/ETCenterTrigramFeatureType.h"
#include "Generic/events/stat/featuretypes/ETNextTrigramFeatureType.h"
#include "Chinese/events/stat/featuretypes/ch_ETLastCharFeatureType.h"
#include "Chinese/events/stat/featuretypes/ch_ETContainsCharFeatureType.h"


bool ChineseEventTriggerFeatureTypes::_instantiated = false;

void ChineseEventTriggerFeatureTypes::ensureFeatureTypesInstantiated() {
	if (_instantiated)
		return;
	_instantiated = true;
	...
	_new ChineseETLastCharFeatureType();
	_new ChineseETContainsCharFeatureType();

	_new ETPrevTrigramFeatureType();
	_new ETCenterTrigramFeatureType();
	_new ETNextTrigramFeatureType();
}
