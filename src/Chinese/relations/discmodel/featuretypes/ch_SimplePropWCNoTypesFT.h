...
#ifndef CH_SIMPLE_PROP_WC_NO_TYPES_FT_H
#define CH_SIMPLE_PROP_WC_NO_TYPES_FT_H
...
class ChineseSimplePropWCNoTypesFT : public P1RelationFeatureType {
public:
	ChineseSimplePropWCNoTypesFT() : P1RelationFeatureType(Symbol(L"simple-prop-wc-no-types")) {}
