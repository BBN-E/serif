...
#ifndef CH_EXP_FEATUREVECTORFILTER_H
#define CH_EXP_FEATUREVECTORFILTER_H
...
class ChineseExpFeatureVectorFilter : public RelationFilter {

public:
   ChineseExpFeatureVectorFilter() : RelationFilter(4) { 
