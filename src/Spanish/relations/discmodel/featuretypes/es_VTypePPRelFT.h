...
#ifndef es_VTYPE_PP_REL_FT_H
#define es_VTYPE_PP_REL_FT_H
...
class SpanishVTypePPRelFT : public P1RelationFeatureType {
public:
	SpanishVTypePPRelFT() : P1RelationFeatureType(Symbol(L"vtype-pp-relation")) {}
