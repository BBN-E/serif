...
#ifndef es_NESTED_PROP_FT_H
#define es_NESTED_PROP_FT_H
...
class SpanishNestedPropFT : public P1RelationFeatureType {
public:
	SpanishNestedPropFT() : P1RelationFeatureType(Symbol(L"nested-prop")) {}
