...
#ifndef es_SIMPLE_PROP_HW_WC_FT_H
#define es_SIMPLE_PROP_HW_WC_FT_H
...
class SpanishSimplePropHWWCFT : public P1RelationFeatureType {
public:
	SpanishSimplePropHWWCFT() : P1RelationFeatureType(Symbol(L"simple-prop-hw-wc")) {}
