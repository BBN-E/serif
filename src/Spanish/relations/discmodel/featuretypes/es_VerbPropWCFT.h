...
#ifndef es_VERB_PROP_WC_FT_H
#define es_VERB_PROP_WC_FT_H
...
class SpanishVerbPropWCFT : public P1RelationFeatureType {
public:
	SpanishVerbPropWCFT() : P1RelationFeatureType(Symbol(L"verb-prop-wc")) {}
