...
#ifndef es_SIMPLE_PROP_FN_FT_H
#define es_SIMPLE_PROP_FN_FT_H
...
class SpanishSimplePropFNFT : public P1RelationFeatureType {
 public:
  SpanishSimplePropFNFT() : P1RelationFeatureType(Symbol(L"simple-prop-framenet")) {}
