...
#ifndef es____PROPTREE_TOPLINK_FT_H___
#define es____PROPTREE_TOPLINK_FT_H___
...
class SpanishPropTreeToplinkFT : public P1RelationFeatureType {
 public:
  SpanishPropTreeToplinkFT() : P1RelationFeatureType(Symbol(L"proptree-toplink")) {}
