...
#ifndef es_PP_REL_WC_FT_H
#define es_PP_REL_WC_FT_H
...
class SpanishPPRelWCFT : public P1RelationFeatureType {
public:
	SpanishPPRelWCFT() : P1RelationFeatureType(Symbol(L"pp-relation-wc")) {}
