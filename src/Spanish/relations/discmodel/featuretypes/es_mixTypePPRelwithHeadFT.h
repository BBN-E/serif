...
#ifndef es_MIXTYPE_PP_REL_WITH_HEAD_FT_H
#define es_MIXTYPE_PP_REL_WITH_HEAD_FT_H
...
class SpanishMixTypePPRelwithHeadFT : public P1RelationFeatureType {
public:
	SpanishMixTypePPRelwithHeadFT() : P1RelationFeatureType(Symbol(L"mixtype-pp-relation-head")) {}
