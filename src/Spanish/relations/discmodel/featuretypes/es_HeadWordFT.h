...
#ifndef es_HEAD_WORD_FT_H
#define es_HEAD_WORD_FT_H
...
class SpanishHeadWordFT : public P1RelationFeatureType {
public:
	SpanishHeadWordFT() : P1RelationFeatureType(Symbol(L"head-word")) {}
