...
#ifndef es_POSSESSIVE_REL_FT_H
#define es_POSSESSIVE_REL_FT_H
...
class SpanishPossessiveRelFT : public P1RelationFeatureType {
public:
	SpanishPossessiveRelFT() : P1RelationFeatureType(Symbol(L"poss-relation")) {}
