...
#ifndef es_SIMPLE_PP_REL_WC_FT_H
#define es_SIMPLE_PP_REL_WC_FT_H
...
class SpanishSimplePPRelWCFT : public P1RelationFeatureType {
public:
	SpanishSimplePPRelWCFT() : P1RelationFeatureType(Symbol(L"simple-pp-relation-wc")) {}
