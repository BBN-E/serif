...
#ifndef es_SIMPLE_PROP_WC_NO_TYPES_FT_H
#define es_SIMPLE_PROP_WC_NO_TYPES_FT_H
...
class SpanishSimplePropWCNoTypesFT : public P1RelationFeatureType {
public:
	SpanishSimplePropWCNoTypesFT() : P1RelationFeatureType(Symbol(L"simple-prop-wc-no-types")) {}
