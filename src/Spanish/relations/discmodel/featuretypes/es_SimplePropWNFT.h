...
#ifndef es_SIMPLE_PROP_WN_FT_H
#define es_SIMPLE_PROP_WN_FT_H
...
class SpanishSimplePropWNFT : public P1RelationFeatureType {
public:
	SpanishSimplePropWNFT() : P1RelationFeatureType(Symbol(L"simple-prop-wordnet")) {}
