...
#ifndef es_SIMPLE_VERB_PROP_HEAD_FT_H
#define es_SIMPLE_VERB_PROP_HEAD_FT_H
...
class SpanishSimpleVerbPropwithTypeFT : public P1RelationFeatureType {
public:
	SpanishSimpleVerbPropwithTypeFT() : P1RelationFeatureType(Symbol(L"simple-verb-prop-type")) {}
