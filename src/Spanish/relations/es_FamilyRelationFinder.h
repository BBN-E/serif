#ifndef es_FAMILY_RELATION_FINDER_H
#define es_FAMILY_RELATION_FINDER_H
...
class SpanishFamilyRelationFinder : public FamilyRelationFinder {
private:
	friend class SpanishFamilyRelationFinderFactory;

public:
	~SpanishFamilyRelationFinder();
...
class SpanishFamilyRelationFinderFactory: public FamilyRelationFinder::Factory {
	virtual FamilyRelationFinder *build() { return _new SpanishFamilyRelationFinder(); } 
};
#endif
