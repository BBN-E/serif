...
#ifndef es_EXPFEATUREVECTORFILTER_H
#define es_EXPFEATUREVECTORFILTER_H
...
class SpanishExpFeatureVectorFilter : public RelationFilter {

public:
  SpanishExpFeatureVectorFilter() : RelationFilter(4) { 
