...
#ifndef es_FEATUREVECTORFILTER_H
#define es_FEATUREVECTORFILTER_H
...
class SpanishFeatureVectorFilter : public RelationFilter {

public:
  SpanishFeatureVectorFilter() : RelationFilter(3) { 
