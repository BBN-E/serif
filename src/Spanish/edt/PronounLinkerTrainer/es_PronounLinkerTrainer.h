...
#ifndef es_PRONOUNLINKERTRAINER_H
#define es_PRONOUNLINKERTRAINER_H
...
class SpanishPronounLinkerTrainer : public PronounLinkerTrainer {
public:
	SpanishPronounLinkerTrainer();
	~SpanishPronounLinkerTrainer();
