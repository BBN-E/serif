...
if(Boost_LIBRARY_DIR)
  ...
  # BEGIN SERIF CUSTOMIZATION
  # This allows us to have a single Boost build directory on Windows
  IF(WIN32 OR WIN64)
    IF (WIN64_TARGET)
      LIST(APPEND _boost_LIBRARY_SEARCH_DIRS "${Boost_INCLUDE_DIR}/Win64/lib")
    ELSE()
      LIST(APPEND _boost_LIBRARY_SEARCH_DIRS "${Boost_INCLUDE_DIR}/Win32/lib")
    ENDIF()
  ENDIF()
  # END SERIF CUSTOMIZATION
...
# since it wasn't added until 1.35. Same for chrono library < 1.47.
if(Boost_VERSION AND Boost_FIND_COMPONENTS)
   if(Boost_VERSION LESS 103500)
     list(REMOVE_ITEM Boost_FIND_COMPONENTS system)
   endif()
   if(Boost_VERSION LESS 104700)
     list(REMOVE_ITEM Boost_FIND_COMPONENTS chrono)
   endif()
endif()
