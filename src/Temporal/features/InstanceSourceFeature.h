#ifndef _INSTANCE_SOURCE_FEATURE_
#define _INSTANCE_SOURCE_FEATURE_
...
BSP_DECLARE(InstanceSourceFeature)
class InstanceSourceFeature : public TemporalFeature {
public:
	InstanceSourceFeature(const std::wstring& instanceSource,
			const Symbol& relation = Symbol());
	static InstanceSourceFeature_ptr create(const std::vector<std::wstring>& parts,
