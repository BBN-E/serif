...
warnings.warn("serifxml3.py in Active/Projects/SERIF/python is deprecated.  Please text-open/src/python/serifxml3.py instead.", DeprecationWarning)
...
if __name__ == '__main__':
    ...
    parser.add_option("-m", '--max_lines', dest='max_lines', help="Maximum number of lines to process (lines in excess of max_lines will be discarded)", default="")
